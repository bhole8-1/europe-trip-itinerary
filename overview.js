import {days,firebaseConfig} from './trip-data.js?v=salzburg-1';
...
const meta=[['vienna','항공 · 도착','VIENNA','plane'],['vienna','도보 · 문화','VIENNA','walk'],['vienna','궁전 · 공연','VIENNA','walk'],['lakes','기차 → 렌터카','LINZ → SALZBURG','train'],['lakes','렌터카 · 호수','SALZKAMMERGUT','car'],['prague','반납 → 기차','LINZ → PRAGUE','train'],['prague','도보 · 구시가지','PRAGUE','walk'],['prague','산책 · 자유시간','PRAGUE','walk'],['prague','항공 · 귀국','PRAGUE → INCHEON','plane']];
