...
export const ticketDefaults=[
  ...
  ['stay-vienna','숙소','빈에서 2박','2026-11-13','11.13 체크인 · 11.15 체크아웃','빈','예약 전','숙소명과 체크인 정보를 적어주세요.'],
  ['rental','렌터카','빈 인수 · 린츠 반납','2026-11-15','11.15 빈 인수 · 11.18 린츠 반납','빈 인수 · 린츠 반납 · 지점 미정','예약 전','15일 빈 인수·18일 린츠 반납 · 지점·운영 시간·편도 반납 조건 확인 필요.'],
  ['stay-lakes','숙소','잘츠부르크 인근에서 3박','2026-11-15','11.15 체크인 · 11.18 체크아웃','잘츠부르크 인근','예약 전','주차 가능한 숙소 · 호수 여행의 거점. 숙소 미정.'],
